...
/**
 * Iterates over attributes in Changeset, attribution string, or attribs property of an op
...
/**
 * does exactly the same as Changeset.filterAttribNumbers 
 */ 
...
etherpad = {}
etherpad.AttributePool = AttributePool
etherpad.Changeset = Changeset
